...
// 2a
let i: 3 = 3;
// @ts-expect-error Error TS2322: Type '4' is not assignable to type '3'.
i = 4;
...
let j = [1, 2, 3]
j.push(4)
// @ts-expect-error Error TS2345: Argument of type '"5"' is not
j.push('5')
...
// 2d
let l: unknown = 4
// @ts-expect-error Error TS2571: Object is of type 'unknown'.
let m = l * 2
